class informeComponent extends HTMLElement {
  constructor() {
    super();
  }
  ...
  async connectedCallback() {
    ...
    try {
      const response = await fetch('view/informe.html');
      ...
      console.error('Error al cargar informe.html:', error);
    }
  }
}

customElements.define('informe-component', informeComponent);
