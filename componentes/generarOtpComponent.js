class GenerarOtpComponent extends HTMLElement {
  constructor() {
    super();
  ...
  async connectedCallback() {
    ...
    try {
      // 1. Cargamos el archivo generarotp.html con cache-busting
      const response = await fetch(
        `view/generarotp.html?v=${new Date().getTime()}`,
        { cache: "no-store" },
      );
      ...
      console.error("Error al cargar generarotp.html:", error);
    }
  }
...
customElements.define("generar-otp-component", GenerarOtpComponent);
