class nominaComponent extends HTMLElement {
  constructor() {
    super();
  }
  ...
  async connectedCallback() {
    ...
    try {
      const response = await fetch('view/nomina.html');
      ...
      console.error('Error al cargar nomina.html:', error);
    }
  }
}

customElements.define('nomina-component', nominaComponent);
