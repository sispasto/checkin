class RegistrarServidorComponent extends HTMLElement {
  constructor() {
    super();
  }
  ...
  async connectedCallback() {
    ...
    try {
      ...
      const response = await fetch("view/registrarServidor.html");
      ...
      console.error("Error al cargar registrarServidor.html:", error);
    }
  }
}

// Registro del nuevo nombre del componente
customElements.define("registrar-servidor", RegistrarServidorComponent);
